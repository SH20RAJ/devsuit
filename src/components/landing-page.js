  ...
  return (
    <div className="flex flex-col min-h-screen">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  DevSuit is the ultimate platform for hackathons, events, and professional networking. Connect,
                  collaborate, and grow your career in tech.
                </p>
              </div>
            ...
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
              ...
              <Card>
                <CardContent className="flex flex-col items-center space-y-4 p-6">
                  ...
                  <p className="text-center text-gray-500 dark:text-gray-400">
                    Find the perfect teammates based on shared interests and skills.
                  </p>
                </CardContent>
              </Card>
              <Card>
            ...
            <div className="grid gap-10 px-10 md:gap-16 lg:grid-cols-2">
              <div className="space-y-4">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Build your profile, showcase your skills, and connect with like-minded peers. Participate in
                  hackathons, find teammates, and explore exciting career opportunities.
                </p>
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Host hackathons, discover top talent, and engage with a community of skilled developers. Post job
                  openings and connect with potential candidates.
                </p>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Whether you're looking to compete, connect, or collaborate, DevSuit is the ultimate platform to
                  achieve your goals in tech.
                </p>
              </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">© 2024 DevSuit. All rights reserved.</p>
